...
class MockTestReportScreen extends StatefulWidget {
  ...
  MockTestReportScreen(this.csvData, this.testType, {Key? key})
      : super(key: key);
...
class _MockTestReportScreenState extends State<MockTestReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var studentRows = _getSelectedClassStudents()?.mapIndexed((index, student) {
          ...
          int sitUpPoints = kData.calculatePoints(
              1, student.age, student.gender, student.sitUpReps);
          int broadJumpPoints = kData.calculatePoints(
              2, student.age, student.gender, student.broadJumpCm);
          int sitAndReachPoints = kData.calculatePoints(
              3, student.age, student.gender, student.sitAndReachCm);
          int pullUpPoints = kData.calculatePoints(
              4, student.age, student.gender, student.pullUpReps);
          int shuttleRunPoints = kData.calculatePointsForShuttleRun(
              5, student.age, student.gender, student.shuttleRunSec);
          int kmRunPoints = kData.calculatePointsForKmRun(
              6, student.age, student.gender, student.runTime);

          int totalPoints = sitUpPoints +
              broadJumpPoints +
              pullUpPoints +
              sitAndReachPoints +
              shuttleRunPoints +
          ...
          return TableRow(
            ...
            children: [
              _buildTableCell('${student.no}', true, false, true, false,
                  const Color(0xffF1F1F1)),
              _buildTableCell(
                  '${student.sitUpReps == -1 ? '' : student.sitUpReps} ($sitUpPoints)',
                  false,
                  false,
                  false,
                  false,
              ...
              _buildTableCell(
                  '${student.broadJumpCm == -1 ? '' : student.broadJumpCm} ($broadJumpPoints)',
                  false,
                  false,
                  false,
                  false,
              ...
              _buildTableCell(
                  '${student.pullUpReps == -1 ? '' : student.pullUpReps} ($pullUpPoints)',
                  false,
                  false,
                  false,
                  false,
              ...
              _buildTableCell(
                  '${student.sitAndReachCm == -1 ? '' : student.sitAndReachCm} ($sitAndReachPoints)',
                  false,
                  false,
                  false,
                  false,
              ...
              _buildTableCell(
                  '${student.shuttleRunSec == -1 ? '' : student.shuttleRunSec} ($shuttleRunPoints)',
                  false,
                  false,
                  false,
                  false,
              ...
              _buildTableCell(
                  '${student.runTime == -1 ? '' : student.runTime} ($kmRunPoints)',
                  false,
                  false,
                  false,
                  false,
                  const Color(0xffb3fbe3)),
              _buildTableCell('$totalPoints', false, true, false, true,
                  const Color(0xffF1F1F1)),
            ],
          );
        }).toList() ??
                    ...
                    TableRow(
                      children: [
                        ...
                        _buildTableHeaderCell(
                            'Sit Up', false, false, const Color(0xffA9A1FF)),
                        _buildTableHeaderCell(
                            'B-Jump', false, false, const Color(0xffFFCB8A)),
                        _buildTableHeaderCell(
                            'Pull Up', false, false, const Color(0xffFF7D7D)),
                        _buildTableHeaderCell('Sit & Reach', false, false,
                            const Color(0xff434343)),
                        _buildTableHeaderCell('Shuttle Run', false, false,
                            const Color(0xffFFA36E)),
                        _buildTableHeaderCell(
                            'Km Run', false, false, const Color(0xff00C485)),
              ...
              Container(
                ...
                child: Table(
                  ...
                  children: [
                    ...
                    TableRow(
                      children: [
                        _buildTableHeaderCell2(
                            'Gold', true, false, false, false),
                        _buildTableHeaderCell2(
                            'Silver', false, false, false, false),
                        _buildTableHeaderCell2(
                            'Bronze', false, false, false, false),
                        _buildTableHeaderCell2(
                    ...
                    TableRow(
                      children: [
                        _buildTableCell2(goldCount.toString(), true, false,
                            false, false, countRowColor, textColorBlack),
                        _buildTableCell2(silverCount.toString(), false, false,
                            false, false, countRowColor, textColorBlack),
                        _buildTableCell2(bronzeCount.toString(), false, false,
                            false, false, countRowColor, textColorBlack),
                        _buildTableCell2(failCount.toString(), false, true,
                            false, false, countRowColor, textColorBlack),
                      ],
                    ),
                  ],
  ...
  Widget _buildTableHeaderCell(String title, bool isFirst, bool isLast,
      [Color? color]) {
    return Container(
      decoration: BoxDecoration(
  ...
  Widget _buildTableCell(String content, bool isFirst, bool isLast,
      bool isTopLeft, bool isTopRight, Color color) {
    return Container(
      decoration: BoxDecoration(
        color: color,
      ),
  ...
  Widget _buildTableHeaderCell2(String title, bool isFirst, bool isLast,
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          ...
          bottomRight:
              isBottomRight ? const Radius.circular(10.0) : Radius.zero,
        ),
      ),
      padding: const EdgeInsets.all(8.0),
      child: Center(
  ...
  Widget _buildTableCell2(String content, bool isFirst, bool isLast,
      bool isTopLeft, bool isTopRight, Color color,
  ...
  Future<void> _generateCSV(
      List<CsvData> dataList, int testType, BuildContext context) async {
    try {
      ...
      // Create file path
      String filePath = testType == 1
          ? '${directory.path}/report.csv'
          : '${directory.path}/mock_report.csv';
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text('Success'),
            content: Text(testType == 1
                ? 'report.csv generated successfully at Downloads folder.'
                : 'mock_report.csv generated successfully at Downloads folder.'),
            actions: [
              TextButton(
                child: Text('OK'),
                onPressed: () {
