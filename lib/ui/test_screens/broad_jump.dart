...
class BroadJumpScreen extends StatefulWidget {
  ...
  BroadJumpScreen({Key? key, required this.testType}) : super(key: key);

  @override
  _BroadJumpScreenState createState() => _BroadJumpScreenState();
}
...
class _BroadJumpScreenState extends State<BroadJumpScreen> {
  ...
  List<Map<String, dynamic>> _getPointsTable() {
    ...
    if (selectedStudent != null) {
      ...
      currentPointsTable = kData.getPointsTable(
          selectedStudent!.age, selectedStudent!.gender, 2);
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(title: const Text('Broad Jump')),
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          color: _selectedRegNo == student.regNo
                              ...
                              : student.broadJumpCm == -1 ? const Color(0xffF1F1F1) : const Color(0xffC9C9C9),
                          ...
                          children: [
                            Expanded(
                              child: ElevatedButton(
                                ...
                                onPressed: _updateBroadJumpDistance,
                                child: const Text(
                                  'Enter',
  ...
  void _updateBroadJumpDistance() async {
        ...
        if (classItem.students[i].regNo == _selectedRegNo) {
          setState(() {
            classItem.students[i] =
                classItem.students[i].copyWith(broadJumpCm: reps);
          });
